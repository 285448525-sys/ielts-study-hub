  ...
  try{
    ...
    (function migrateWritingTemplates(){
      ...
      const categoryUpdates = {
        wt_a: '小作文动态图', wt_b: '小作文静态图', wt_c: '小作文地图题', wt_d: '小作文流程图',
        wt_ba: '大作文观点型', wt_bb: '大作文讨论型',
        wt_a5: '小作文动态图', wt_b5: '小作文静态图', wt_c5a: '小作文地图题', wt_c5b: '小作文地图题', wt_d5: '小作文流程图',
        wt_cr1: '大作文Report', wt_cr2: '大作文Report'
      };
