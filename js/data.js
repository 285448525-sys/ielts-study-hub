...
/* ===== 9-12 月口语题库（2026-09-20 雅思哥 0920 版，大陆考区 + APP 在考；频次=近10天 APP 实测四档；P1 38 组 / P2 62 张） ===== */
const FREQ_LABEL = { ultra:'超高频', high:'高频', medium:'中频', low:'低频' };
const SPEAKING_BANK = [
/* ---------- Part 1 · 超高频（3） ---------- */
{ id:"sb_p1_bored", type:"P1", period:"2026-09-20", isNew:true, frequency:"ultra", category:"日常",
    titleEn:"Feeling bored", titleZh:"无聊",
    questions:[
...
{ id:"sb_p1_computers", type:"P1", period:"2026-09-20", isNew:true, frequency:"ultra", category:"事物",
    titleEn:"Computers and tablets", titleZh:"电脑与平板",
    questions:[
    ...
    cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p1_streetmarket", type:"P1", period:"2026-09-20", isNew:true, frequency:"ultra", category:"日常",
    titleEn:"Street market", titleZh:"街边市场",
    questions:[
    ...
    cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
/* ---------- Part 1 · 高频（8） ---------- */
{ id:"sb_p1_work", type:"P1", period:"2026-09-20", isNew:false, frequency:"high", category:"日常",
...
{ id:"sb_p1_watch", type:"P1", period:"2026-09-20", isNew:false, frequency:"high", category:"事物",
...
{ id:"sb_p1_collecting", type:"P1", period:"2026-09-20", isNew:true, frequency:"high", category:"日常",
    titleEn:"Collecting things", titleZh:"收集物品",
    questions:[
    ...
    cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p1_paper", type:"P1", period:"2026-09-20", isNew:true, frequency:"high", category:"日常",
    ...
    cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p1_fruitveg", type:"P1", period:"2026-09-20", isNew:true, frequency:"high", category:"日常",
    ...
    cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p1_area", type:"P1", period:"2026-09-20", isNew:false, frequency:"high", category:"地点",
    ...
    cue:'', content:'', keywords:'', linkedTo:"必考题", proficiency:"没练" },
{ id:"sb_p1_lostfound", type:"P1", period:"2026-09-20", isNew:true, frequency:"high", category:"日常",
    titleEn:"Lost and found", titleZh:"丢失与拾获",
    questions:[
    ...
    cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p1_politeness", type:"P1", period:"2026-09-20", isNew:true, frequency:"high", category:"日常",
    ...
    cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
/* ---------- Part 1 · 中频（13） ---------- */
{ id:"sb_p1_shoes", type:"P1", period:"2026-09-20", isNew:true, frequency:"medium", category:"事物",
    ...
    cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p1_secondaryschool", type:"P1", period:"2026-09-20", isNew:true, frequency:"medium", category:"日常",
    ...
    cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p1_cars", type:"P1", period:"2026-09-20", isNew:false, frequency:"medium", category:"事物",
    ...
    cue:'', content:'', keywords:'', linkedTo:"可套框架④", proficiency:"没练" },
{ id:"sb_p1_rubbish", type:"P1", period:"2026-09-20", isNew:true, frequency:"medium", category:"日常",
    ...
    cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p1_websites", type:"P1", period:"2026-09-20", isNew:false, frequency:"medium", category:"事物",
    ...
    cue:'', content:'', keywords:'', linkedTo:"可套框架④", proficiency:"没练" },
{ id:"sb_p1_music", type:"P1", period:"2026-09-20", isNew:false, frequency:"medium", category:"日常",
    ...
    cue:'', content:'', keywords:'', linkedTo:"可套框架①", proficiency:"没练" },
{ id:"sb_p1_friends", type:"P1", period:"2026-09-20", isNew:true, frequency:"medium", category:"人物",
    titleEn:"Friends", titleZh:"朋友",
    questions:[
    ...
    cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p1_hometown", type:"P1", period:"2026-09-20", isNew:false, frequency:"medium", category:"地点",
    ...
    cue:'', content:'', keywords:'', linkedTo:"可套框架②", proficiency:"没练" },
{ id:"sb_p1_tiredness", type:"P1", period:"2026-09-20", isNew:true, frequency:"medium", category:"日常",
    ...
    cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p1_home", type:"P1", period:"2026-09-20", isNew:false, frequency:"medium", category:"地点",
    ...
    cue:'', content:'', keywords:'', linkedTo:"必考题", proficiency:"没练" },
{ id:"sb_p1_advertisement", type:"P1", period:"2026-09-20", isNew:true, frequency:"medium", category:"日常",
    ...
    cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p1_parks", type:"P1", period:"2026-09-20", isNew:false, frequency:"medium", category:"日常",
    ...
    cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p1_teachers", type:"P1", period:"2026-09-20", isNew:false, frequency:"medium", category:"人物",
    ...
    cue:'', content:'', keywords:'', linkedTo:"可套框架⑤", proficiency:"没练" },
/* ---------- Part 1 · 低频（14） ---------- */
{ id:"sb_p1_mirrors", type:"P1", period:"2026-09-20", isNew:false, frequency:"low", category:"事物",
    ...
    cue:'', content:'', keywords:'', linkedTo:"可套框架④", proficiency:"没练" },
{ id:"sb_p1_travelling", type:"P1", period:"2026-09-20", isNew:true, frequency:"low", category:"日常",
    ...
    cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p1_shopping", type:"P1", period:"2026-09-20", isNew:false, frequency:"low", category:"日常",
    ...
    cue:'', content:'', keywords:'', linkedTo:"可套框架③", proficiency:"没练" },
{ id:"sb_p1_opportunities", type:"P1", period:"2026-09-20", isNew:true, frequency:"low", category:"日常",
    titleEn:"Opportunities", titleZh:"机会",
    questions:[
    "Do you often get new opportunities?",
    "Do you like taking on new opportunities?",
    ...
    cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p1_singing", type:"P1", period:"2026-09-20", isNew:false, frequency:"low", category:"日常",
    ...
    cue:'', content:'', keywords:'', linkedTo:"可套框架①", proficiency:"没练" },
{ id:"sb_p1_clothing", type:"P1", period:"2026-09-20", isNew:false, frequency:"low", category:"事物",
    ...
    cue:'', content:'', keywords:'', linkedTo:"可套框架④", proficiency:"没练" },
{ id:"sb_p1_science", type:"P1", period:"2026-09-20", isNew:false, frequency:"low", category:"事物",
    ...
    cue:'', content:'', keywords:'', linkedTo:"可套框架⑥", proficiency:"没练" },
{ id:"sb_p1_morning", type:"P1", period:"2026-09-20", isNew:true, frequency:"low", category:"日常",
    titleEn:"Morning time", titleZh:"早晨时光",
    questions:[
    ...
    cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p1_tidiness", type:"P1", period:"2026-09-20", isNew:false, frequency:"low", category:"日常",
    ...
    cue:'', content:'', keywords:'', linkedTo:"可套框架③", proficiency:"没练" },
{ id:"sb_p1_space", type:"P1", period:"2026-09-20", isNew:false, frequency:"low", category:"事物",
    ...
    cue:'', content:'', keywords:'', linkedTo:"可套框架⑥", proficiency:"没练" },
{ id:"sb_p1_headphones", type:"P1", period:"2026-09-20", isNew:false, frequency:"low", category:"事物",
    ...
    cue:'', content:'', keywords:'', linkedTo:"可套框架④", proficiency:"没练" },
{ id:"sb_p1_socialmedia", type:"P1", period:"2026-09-20", isNew:false, frequency:"low", category:"日常",
    ...
    cue:'', content:'', keywords:'', linkedTo:"可套框架④", proficiency:"没练" },
{ id:"sb_p1_name", type:"P1", period:"2026-09-20", isNew:true, frequency:"low", category:"日常",
    ...
    cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p1_jokes", type:"P1", period:"2026-09-20", isNew:false, frequency:"low", category:"日常",
    ...
    cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
/* ---------- Part 2&3 · 超高频（1） ---------- */
{ id:"sb_p2_timesaving", type:"P2", period:"2026-09-20", isNew:true, frequency:"ultra", category:"事件",
    titleEn:"A way/change that helps you save a lot of time", titleZh:"节约时间的方法/改变",
    promptEn:"Describe a way/change that helps you save a lot of time", promptZh:"描述一个帮你节省大量时间的方法或改变。",
    youShouldSay:[
    "What it is",
...
/* ---------- Part 2&3 · 高频（9） ---------- */
{ id:"sb_p2_metonce", type:"P2", period:"2026-09-20", isNew:true, frequency:"high", category:"人物",
    titleEn:"A person you only met once and want to know more about", titleZh:"一见且想继续了解的人",
    promptEn:"Describe a person you only met once recently and want to know more about", promptZh:"描述一个你最近只见过一次、还想继续了解的人。",
    youShouldSay:[
    "Who he/she is",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_lostpublic", type:"P2", period:"2026-09-20", isNew:true, frequency:"high", category:"事件",
    titleEn:"An occasion you lost something in public", titleZh:"公共场所丢物品",
    promptEn:"Describe an occasion that you lost something in public", promptZh:"描述一次你在公共场所丢了东西的经历。",
    youShouldSay:[
    "What you lost",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_course", type:"P2", period:"2026-09-20", isNew:true, frequency:"high", category:"事件",
    titleEn:"A course that impressed you a lot", titleZh:"印象深刻的课程",
    promptEn:"Describe a course that impressed you a lot", promptZh:"描述一门让你印象很深的课程。",
    youShouldSay:[
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_giftfriend", type:"P2", period:"2026-09-20", isNew:true, frequency:"high", category:"事物",
    titleEn:"A gift you would like to buy for your friend", titleZh:"送朋友的礼物",
    promptEn:"Describe a gift you would like to buy for your friend", promptZh:"描述一件你想买给朋友的礼物。",
    youShouldSay:[
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_handmade", type:"P2", period:"2026-09-20", isNew:true, frequency:"high", category:"人物",
    titleEn:"A person who is good at making things by hand", titleZh:"擅长做手工的人",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_animalstory", type:"P2", period:"2026-09-20", isNew:false, frequency:"high", category:"事件",
    titleEn:"A story/book with animals in it", titleZh:"包含动物的故事或书",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_savingmoney", type:"P2", period:"2026-09-20", isNew:true, frequency:"high", category:"事件",
    titleEn:"A time you saved money to buy something special", titleZh:"攒钱买特别物品",
    promptEn:"Describe a time when you saved money to buy something special", promptZh:"描述一次你攒钱买特别物品的经历。",
    youShouldSay:[
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_recentchange", type:"P2", period:"2026-09-20", isNew:true, frequency:"high", category:"事件",
    titleEn:"A change that you made recently", titleZh:"近期改变",
    promptEn:"Describe a change that you made recently", promptZh:"描述一个你近期做出的改变。",
    youShouldSay:[
    "What the change was",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_happydecision", type:"P2", period:"2026-09-20", isNew:true, frequency:"high", category:"事件",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
/* ---------- Part 2&3 · 中频（21） ---------- */
{ id:"sb_p2_leastfilm", type:"P2", period:"2026-09-20", isNew:true, frequency:"medium", category:"事物",
    titleEn:"Your least favourite movie", titleZh:"不喜欢的电影",
    promptEn:"Describe a movie/film you don’t like", promptZh:"描述一部你最不喜欢的电影。",
    youShouldSay:[
    "When you watched it",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_difficultsuccess", type:"P2", period:"2026-09-20", isNew:true, frequency:"medium", category:"人物",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_longtermgoal", type:"P2", period:"2026-09-20", isNew:true, frequency:"medium", category:"抽象",
    titleEn:"A long-term goal/ambition you would like to achieve", titleZh:"长久目标/抱负",
    promptEn:"Describe a long-term goal/ambition you would like to achieve", promptZh:"描述一个你想要实现的长期目标或抱负。",
    youShouldSay:[
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_medperson", type:"P2", period:"2026-09-20", isNew:false, frequency:"medium", category:"人物",
...
{ id:"sb_p2_admireathlete", type:"P2", period:"2026-09-20", isNew:true, frequency:"medium", category:"人物",
    titleEn:"A successful sportsperson you admire", titleZh:"钦佩的运动员",
    promptEn:"Describe a successful sportsperson you admire", promptZh:"描述一个你钦佩的运动员。",
    youShouldSay:[
    "Who he/she is",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_recommendplace", type:"P2", period:"2026-09-20", isNew:false, frequency:"medium", category:"地点",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_lawenv", type:"P2", period:"2026-09-20", isNew:false, frequency:"medium", category:"事件",
...
{ id:"sb_p2_noisyplace", type:"P2", period:"2026-09-20", isNew:true, frequency:"medium", category:"地点",
    titleEn:"A noisy place you have been to", titleZh:"嘈杂地",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_eldersadmire", type:"P2", period:"2026-09-20", isNew:true, frequency:"medium", category:"人物",
    ...
    "And explain how you feel about this person"],
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_waitmsg", type:"P2", period:"2026-09-20", isNew:false, frequency:"medium", category:"事件",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_tallbuilding", type:"P2", period:"2026-09-20", isNew:false, frequency:"medium", category:"地点",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_childhoodfriend", type:"P2", period:"2026-09-20", isNew:false, frequency:"medium", category:"人物",
...
{ id:"sb_p2_interviewceleb", type:"P2", period:"2026-09-20", isNew:true, frequency:"medium", category:"事件",
    titleEn:"A time you watched a famous person being interviewed", titleZh:"看过的名人采访",
    promptEn:"Describe a time you watched a famous person being interviewed", promptZh:"描述一次你观看名人接受采访的经历。",
    youShouldSay:[
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_helphealth", type:"P2", period:"2026-09-20", isNew:true, frequency:"medium", category:"人物",
    titleEn:"A person with healthy habits and a healthy daily routine", titleZh:"有健康习惯和作息的人",
    promptEn:"Describe a person you know who has healthy habits and a healthy daily routine", promptZh:"描述一次你帮助他人改善健康的经历。",
    youShouldSay:[
    "Who this person is",
    ...
    "And explain how you feel about him/her"],
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_photoperson", type:"P2", period:"2026-09-20", isNew:true, frequency:"medium", category:"人物",
    ...
    "And explain how you feel about him/her"],
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_teachskill", type:"P2", period:"2026-09-20", isNew:true, frequency:"medium", category:"人物",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_crowdedplace", type:"P2", period:"2026-09-20", isNew:true, frequency:"medium", category:"地点",
    titleEn:"A crowded place you went to", titleZh:"拥挤地方",
    ...
    "What you did there"],
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_langperson", type:"P2", period:"2026-09-20", isNew:false, frequency:"medium", category:"人物",
    ...
    "And explain how you feel about him/her"],
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_wastetime", type:"P2", period:"2026-09-20", isNew:true, frequency:"medium", category:"事件",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_eveningfriends", type:"P2", period:"2026-09-20", isNew:true, frequency:"medium", category:"事件",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_happyperson", type:"P2", period:"2026-09-20", isNew:true, frequency:"medium", category:"人物",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
/* ---------- Part 2&3 · 低频（31） ---------- */
{ id:"sb_p2_favbuilding", type:"P2", period:"2026-09-20", isNew:true, frequency:"low", category:"地点",
    titleEn:"A public building you enjoy visiting", titleZh:"喜欢的公共建筑",
    promptEn:"Describe a public building you enjoy visiting (e.g. a library, a shopping mall, etc.)", promptZh:"描述一栋你喜欢的建筑。",
    youShouldSay:[
    "Where it is",
    "How you knew it",
    "What it looks like",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_historyperson", type:"P2", period:"2026-09-20", isNew:true, frequency:"low", category:"人物",
    ...
    "And explain how you feel about him/her"],
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_naturalplace", type:"P2", period:"2026-09-20", isNew:true, frequency:"low", category:"地点",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_popularperson", type:"P2", period:"2026-09-20", isNew:true, frequency:"low", category:"人物",
    titleEn:"A popular person", titleZh:"受欢迎的人",
    promptEn:"Describe a popular person", promptZh:"描述一个受欢迎的人。",
    youShouldSay:[
    "Who this person is",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_adceleb", type:"P2", period:"2026-09-20", isNew:false, frequency:"low", category:"事物",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_bizowner", type:"P2", period:"2026-09-20", isNew:false, frequency:"low", category:"人物",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_newlaw", type:"P2", period:"2026-09-20", isNew:false, frequency:"low", category:"事件",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"可套舅舅母本", proficiency:"没练" },
{ id:"sb_p2_earlyrise", type:"P2", period:"2026-09-20", isNew:false, frequency:"low", category:"事件",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_happybook", type:"P2", period:"2026-09-20", isNew:true, frequency:"low", category:"事物",
    titleEn:"A book you read that made you happy", titleZh:"读起来开心的书",
    promptEn:"Describe a book you read that made you happy", promptZh:"描述一本读起来让你开心的书。",
    youShouldSay:[
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_specialfood", type:"P2", period:"2026-09-20", isNew:false, frequency:"low", category:"事物",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_boringplace", type:"P2", period:"2026-09-20", isNew:false, frequency:"low", category:"地点",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_goodservice", type:"P2", period:"2026-09-20", isNew:true, frequency:"low", category:"事件",
    titleEn:"Good service in a shop", titleZh:"好的购物服务",
    promptEn:"Describe a time when you received good service in a shop/store/company", promptZh:"描述一次你在商店获得良好服务的经历。",
    youShouldSay:[
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_plantsperson", type:"P2", period:"2026-09-20", isNew:false, frequency:"low", category:"人物",
    titleEn:"A person who loves to grow plants", titleZh:"喜欢在家/花园种植植物的人",
...
{ id:"sb_p2_changemind", type:"P2", period:"2026-09-20", isNew:false, frequency:"low", category:"事件",
    ...
    "And explain how you felt about the experience"],
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_livesport", type:"P2", period:"2026-09-20", isNew:true, frequency:"low", category:"事件",
    titleEn:"A live sports event you watched and liked", titleZh:"喜欢的现场体育赛事",
    promptEn:"Describe a live sports event you watched and liked", promptZh:"描述一场你看过并且喜欢的现场体育赛事。",
    youShouldSay:[
    "What it was",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_dislikeshorttrip", type:"P2", period:"2026-09-20", isNew:true, frequency:"low", category:"事件",
    titleEn:"A short trip you often take but do not like", titleZh:"不喜欢的短途旅行",
    promptEn:"Describe a short trip you often take but do not like", promptZh:"描述一次你不喜欢的短途旅行。",
    youShouldSay:[
    "Where you go",
    "When you go there",
    "Why you go there",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_techprob", type:"P2", period:"2026-09-20", isNew:false, frequency:"low", category:"事件",
...
{ id:"sb_p2_video", type:"P2", period:"2026-09-20", isNew:false, frequency:"low", category:"事物",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_teamwork", type:"P2", period:"2026-09-20", isNew:false, frequency:"low", category:"事件",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_visitnotlive", type:"P2", period:"2026-09-20", isNew:false, frequency:"low", category:"地点",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_cityagain", type:"P2", period:"2026-09-20", isNew:true, frequency:"low", category:"地点",
    titleEn:"A city you have been to and would like to visit again", titleZh:"想再去一次的城市",
    promptEn:"Describe a city that you have been to and would like to visit again", promptZh:"描述一个你去过并想再去一次的城市。",
    youShouldSay:[
    "When you visited it",
    "What you did there",
    "What it was like",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_impressiveparty", type:"P2", period:"2026-09-20", isNew:true, frequency:"low", category:"事件",
    titleEn:"A party for a special event that impressed you a lot", titleZh:"印象深刻的聚会",
    promptEn:"Describe a party for a special event that impressed you a lot", promptZh:"描述一个让你印象深刻的聚会。",
    youShouldSay:[
    ...
    "And explain why it impressed you a lot"],
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_childskill", type:"P2", period:"2026-09-20", isNew:true, frequency:"low", category:"事件",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_organized", type:"P2", period:"2026-09-20", isNew:true, frequency:"low", category:"人物",
    titleEn:"A person you know who is very organized", titleZh:"有条理的人",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_helpothers", type:"P2", period:"2026-09-20", isNew:true, frequency:"low", category:"事件",
    titleEn:"A time when you helped someone", titleZh:"帮助他人",
    promptEn:"Describe a time when you helped someone", promptZh:"描述一次你帮助别人的经历。",
    youShouldSay:[
    ...
    "And explain how you felt about it"],
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_decision", type:"P2", period:"2026-09-20", isNew:false, frequency:"low", category:"事件",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_localnews", type:"P2", period:"2026-09-20", isNew:false, frequency:"low", category:"事件",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_ecolaw", type:"P2", period:"2026-09-20", isNew:false, frequency:"low", category:"事件",
    ...
    "And explain how you feel about this law"],
    questions:[], cue:'', content:'', keywords:'', linkedTo:"可套舅舅母本", proficiency:"没练" },
{ id:"sb_p2_uninterested", type:"P2", period:"2026-09-20", isNew:true, frequency:"low", category:"事件",
    ...
    "And explain how you felt about the experience"],
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_smartproblem", type:"P2", period:"2026-09-20", isNew:false, frequency:"low", category:"人物",
    ...
    questions:[], cue:'', content:'', keywords:'', linkedTo:"", proficiency:"没练" },
{ id:"sb_p2_planchange", type:"P2", period:"2026-09-20", isNew:false, frequency:"low", category:"事件",
...
const SPEAKING_BANK_META = {
  ...
  region: '大陆考区',
  updated: '2026-09-20',
  note: '0920 版：P1 38 组 / P2 62 张（含 APP 在考题）；频次=近10天雅思哥 APP 实测人数四档（超高频/高频/中频/低频），快照 2026-09-23。优先练超高频与高频，低频过思路即可。'
};
