...
let DATA = {
  ...
  writing: [
    ...
    // === 5.0 目标万能版（新增）===
    { id:'wt_a5', category:'动态图', title:'动态图万能版（5分目标）', skeleton:'The 【chart/graph】 shows 【图内容】 from 【年份 A】 to 【年份 B】. This gives a clear overview of the information.\n\nOverall, it is clear that 【数据 A】 went up a lot and 【数据 B】 went down. Additionally, this is the most striking feature.\n\nLooking at the details, 【数据 A】 started at 【数值】 in 【年份 A】 and then went up to 【数值】 in 【年份 B】. This was a big change. 【数据 B】 was different. It started at 【数值】 and then went down to 【数值】. This is very clear.\n\nIn conclusion, this is easy to understand. The information was very different and changed clearly.', tips:'5分保底版。4句通用句已嵌在骨架里。如果只有一个数据：Overall 改写成 the number went up a lot；如果有数据不变：【数据 C】 stayed the same. It did not change.' },
    { id:'wt_b5', category:'静态图', title:'静态图万能版（5分目标）', skeleton:'The 【pie chart/table】 shows 【图内容】. The data is in 【percent/number】. This gives a clear overview of the information.\n\nOverall, it is clear that 【最大类】 was the biggest part. Additionally, this is the most striking feature.\n\nLooking at the details, 【最大类】 was 【数值】%. 【类 2】 was 【数值】%. 【类 3】 was 【数值】%. 【类 4】 was 【数值】%. 【类 5】 was 【数值】%. This is very clear.\n\nIn conclusion, this is easy to understand. The information was very different and changed clearly.', tips:'5分保底版。4句通用句已嵌在骨架里。类别不够5个时，有几类写几类。' },
    { id:'wt_c5a', category:'地图题', title:'地图题万能版·对比两个图（5分目标）', skeleton:'The two diagrams show 【图 A】 and 【图 B】. This gives a clear overview of the information.\n\nOverall, it is clear that 【图 B】 is bigger and has more things. Additionally, this is the most striking feature.\n\nLooking at the details, 【图 A】 has 【物品 1】 and 【物品 2】. It is simple and small. In contrast, 【图 B】 has 【物品 3】 and 【物品 4】. There is also 【物品 5】 in 【图 B】, but 【图 A】 does not have it. This is very clear.\n\nIn conclusion, this is easy to understand. The information was very different and changed clearly.', tips:'5分保底版。4句通用句已嵌在骨架里。用于房间A vs B / Plan A vs B 等对比型地图或平面图。' },
    { id:'wt_c5b', category:'地图题', title:'地图题万能版·before & after（5分目标）', skeleton:'The two maps show 【地方】 in 【年份 A】 and 【年份 B】. This gives a clear overview of the information.\n\nOverall, it is clear that the area changed a lot. Additionally, this is the most striking feature.\n\nIn the past, there was 【旧 A】 in the north. Now it is 【新 A】. The 【旧 B】 in the west was removed. People built 【新 B】 there instead. This was a big change. 【新 C】 was built in the east, and 【新 D】 appeared in the south. However, 【不变】 in the center stayed the same. This is very clear.\n\nIn conclusion, this is easy to understand. The information was very different and changed clearly.', tips:'5分保底版。4句通用句已嵌在骨架里。用于同一地点的改造前后对比。' },
    { id:'wt_d5', category:'流程图', title:'流程图万能版（5分目标）', skeleton:'The diagram shows how 【过程】 works. This gives a clear overview of the information.\n\nOverall, it is clear that there are several steps. Additionally, this is the most striking feature.\n\nFirst, 【东西 A】 goes into 【地点 A】. Then it becomes 【东西 B】. Next, 【东西 B】 moves to 【地点 B】. After that, 【东西 C】 appears. It changes into 【东西 D】. This was a big change. Finally, 【最终结果】 is finished. This is very clear.\n\nIn conclusion, this is easy to understand. The information was very different and changed clearly.', tips:'5分保底版。4句通用句已嵌在骨架里。卡住时用兜底句：Then it goes to the next stage. / It did not change. / This was a big change. / This is very clear.' },
    // === 大作文C Report 题型（新增，2026-08-22）===
    { id:'wt_cr1', category:'Report', title:'原因+解决/结果（万能版）', skeleton:'The debate surrounding 【话题】 has engaged a broad audience recently. This essay will look at why this happens and what can be done.\n\nFirst of all, there are several clear reasons. One key reason is that it affects 【普适领域】, thereby building a firm basis for 【进阶目标】. As a result, this not only causes short-term problems but also leads to long-term outcomes. Another significant reason is that it creates problems from the ground up by removing 【潜在原因】. For example, this has influenced many people and reduced life satisfaction. This then creates a ripple effect that hurts a wide range of people in their daily lives.\n\nHowever, there are ways to deal with this. In my opinion, 【解决方案】 matters more in the long run. This is because if we do not fix this basic problem first, the bad results will not stop. More importantly, these short-term ideas often hide deeper problems that quick fixes cannot solve. In the end, the problems caused by ignoring the real issue are much bigger than any short-term comfort it gives.\n\nIn conclusion, 【话题】 is a complex issue. On the one hand, it has clear reasons; on the other hand, there are practical solutions. Therefore, we should take action to improve the situation and make the overall impact largely positive.', tips:'Report 题型（题干问 why + how/what）。开头双句固定；Body1 写原因，Body2 写解决/结果；结尾呼吁行动。只填名词短语，不自己造语法。' },
    { id:'wt_cr2', category:'Report', title:'只问原因（万能版）', skeleton:'The debate surrounding 【话题】 has engaged a broad audience recently. This essay will look at why this happens.\n\nFirst of all, there are several clear reasons. One key reason is that it affects 【普适领域】, thereby building a firm basis for 【进阶目标】. As a result, this not only causes short-term problems but also leads to long-term outcomes. Another significant reason is that it creates problems from the ground up by removing 【潜在原因】. For example, this has influenced many people and reduced life satisfaction. This then creates a ripple effect that hurts a wide range of people in their daily lives.\n\nHowever, there are also other reasons. In my opinion, 【原因 2】 matters more in the long run. This is because if we do not see this basic reason first, the bad results will not stop. More importantly, these short-term ideas often hide deeper problems that quick fixes cannot solve. In the end, the problems caused by ignoring the real issue are much bigger than any short-term comfort it gives.\n\nIn conclusion, 【话题】 is a complex issue. On the one hand, it has clear reasons; on the other hand, these reasons are connected. Therefore, we should take action to improve the situation and make the overall impact largely positive.', tips:'Report 题型（题干只问 why）。开头写 This essay will look at why this happens；Body1 原因1，Body2 原因2（只改 2 句），结尾强调原因相连。' },
    // === 大作文C Report 题型（新增「先表态再分析」变体，2026-08-23，用户自制骨架）===
    { id:'wt_cr3', category:'Report', title:'先表态再分析（万能版）', skeleton:'The debate surrounding 【话题】 has engaged a broad audience recently. From my perspective, 【话题】 is a serious problem, and this essay will discuss why it happens【题型尾巴：, and how to solve it（原因+解决题型保留）/ 留空（只问原因题型）】.\n\nFirst of all, there are several clear reasons. One key strength is its ability to improve 【普适领域】, thereby building a firm basis for 【进阶目标】. As a result, this practice not only generates short-term benefits but also contributes to long-term outcomes. Another significant advantage is that it addresses problems from the ground up by removing 【潜在原因】. For example, this has helped many people and improved life satisfaction. This then creates a ripple effect that helps a wide range of people in their daily lives.\n\nHowever, there are also other reasons【Body2 取向：ways to deal with this（原因+解决题型）/ other reasons（只问原因题型）】. In my opinion, 【原因 2 / 解决方案】 matters more in the long run. This is because if we do not fix this basic problem first, the bad results will not stop. More importantly, these short-term ideas often hide deeper problems that quick fixes cannot solve. In the end, the problems caused by ignoring the real issue are much bigger than any short-term comfort it gives.\n\nIn conclusion, 【话题】 is a complex problem, and we should take action. On the one hand, it has clear reasons; on the other hand, these reasons are connected【结尾尾巴：there are practical solutions（原因+解决题型保留）/ 留空（只问原因题型）】. Therefore, the overall impact should be viewed as largely positive.', tips:'Report 题型（用户自制「先亮立场」变体）。开头直接表态【话题】is a serious problem；Body1 写原因（strength/advantage 措辞），Body2 按题型选「解决」或「原因2」；结尾呼吁行动。括号【】里是可选项，按题干是否问 how/what 决定保留或删掉。只填名词短语，不自己造语法。' },
    // === 大作文C Report 题型（新增「先表态再分析·原因版（少背）」，2026-08-23，用户自制骨架）===
    { id:'wt_cr4', category:'Report', title:'先表态再分析·原因版（少背）', skeleton:'The debate surrounding 【话题】 has engaged a broad audience recently. From my perspective, 【话题】 is a serious problem, and this essay will discuss why it happens.\n\nFirst of all, there are several clear reasons. One key reason is that it affects 【普适领域】, thereby building a firm basis for 【进阶目标】. As a result, this not only causes short-term problems but also leads to long-term outcomes. Another significant reason is that it creates problems from the ground up by removing 【潜在原因】. For example, this has influenced many people and reduced life satisfaction. This then creates a ripple effect that hurts a wide range of people in their daily lives.\n\nHowever, there are also other reasons. In my opinion, 【原因2】 matters more in the long run. This is because if we do not fix this basic problem first, the bad results will not stop. More importantly, these short-term ideas often hide deeper problems that quick fixes cannot solve. In the end, the problems caused by ignoring the real issue are much bigger than any short-term comfort it gives.\n\nIn conclusion, 【话题】 is a complex problem, and we should take action. On the one hand, it has clear reasons; on the other hand, these reasons are connected. Therefore, the overall impact should be viewed as largely positive.', tips:'Report 题型（用户自制「先亮立场·只问原因」精简版，背得最少）。开头直接表态 + 只讨论 why；Body1 原因1（One key reason / Another significant reason 措辞），Body2 原因2（固定 other reasons + 【原因2】）；结尾呼吁行动。题干只问 why 时用这条最省。只填名词短语，不自己造语法。' }
  ],
  writingPhrases: [
