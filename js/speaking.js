...
var SYS_DIAG =
  ...
  + '1) 按流利度(fluency)、词汇(vocabulary)、语法(grammar)三项评分（0-9，可含0.5）。评分要宽容：意思能听懂、能连贯表达，就给5.5以上，不要压分。\n'
  + '2) 纠错：只挑真正的语法错误和用词错误。其他一律不管——大小写、标点、空格、断句、说法不够地道、原句可接受但换种说法更好，这些全都不要提，也不要写进 errors。没有真错误就写空数组 []。\n'
  + '3) 按考生原思路给一版简单、地道的英文重写（只改真错误），再给1-2个可积累的地道替换词/句型。\n'
...
var SYS_DIAG_P2 =
  ...
  + '1) 按流利度(fluency)、词汇(vocabulary)、语法(grammar)三项评分（0-9，可含0.5），并给总分overall。评分要宽容：意思能听懂、能连贯表达，就给5.5以上，不要压分。\n'
  + '2) 纠错：只挑真正的语法错误和用词错误。其他一律不管——大小写、标点、空格、断句、说法不够地道、原句可接受但换种说法更好，这些全都不要提，也不要写进 errors。没有真错误就写空数组 []。\n'
  + '3) 串题素材连接(storyLink)：考生有万能故事素材（见用户消息末尾），建议可套用哪个素材、怎么嵌入（中文2-4行）。\n'
  + '4) 按考生原思路给一版简单、地道的英文重写（只改真错误），再给1-2个可积累的地道替换词/句型。\n'
