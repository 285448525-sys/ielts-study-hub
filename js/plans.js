...
async function aiPlanItem(){
  ...
  const sys = '你是雅思备考日计划教练。考生会写一句话描述今天想完成的目标。'
    + '请根据考生弱项、最近模考、目标分和考试倒计时，把目标拆成 4-6 个大概的今日任务。'
    + '任务要求：① 只写任务本身，不要带时间段、不要写预估时长、不要用括号加任何说明或提示；② 弱项科目多排、优先排；③ 同类任务分散，避免疲劳；④ 模考/套题必须整体出现，例如"听力限时模考""阅读限时模考"，不能拆成"听力 S1""阅读 P1"等；⑤ 把最难的任务排在前面。'
