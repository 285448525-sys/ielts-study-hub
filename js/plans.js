...
var PART_RULE = '\n'
  ...
  + '- 阅读 = Passage，写作 P1/P2/P3；听力 = Section，按考生习惯同样写作 P1/P2/P3/P4（**严禁写 S1/S2**，她不这么叫）。\n'
  + '- 任务名固定为「科目 + Part + 第N篇」，如「阅读 P2 第1篇」「听力 P4 第1篇」。\n'
  + '- 考生写出了 part 与篇号区间（如「阅读 P2 1–5」「听力 P4 1–6」「P2 16–19 (4)」「P4 19–23(5)+P3 1–2(2)」）：**严格按她写的 part 与起始篇号逐个展开**，一个篇号一个独立任务——「阅读 P2 16–19」→「阅读 P2 第16篇」「阅读 P2 第17篇」「阅读 P2 第18篇」「阅读 P2 第19篇」；多 part 组合（如「P4 19–23 + P3 1–2」）按她写的先后顺序依次展开，各段从她写的起点开始编号。\n'
  + '- 考生只写了 part 没写篇号（如「阅读 P2」「听力 P4 3 篇」）：从「第1篇」起编，编到她写的篇数。\n'
  ...
  + '- 她同时写了时长（如「听力 P4 30 分钟」）：时长放在最后，如「听力 P4 第1篇 30 分钟」。\n';
