...
async function aiWeekPlan(){
  ...
  const sys = '你是资深雅思备考计划教练。考生会在文本框里写下"接下来几天内要做的一些任务 + 具体安排"，可能是自由格式（含"今天/明天/周X/上午/下午/具体日期"等时间词），也可能只是一份任务清单，且常使用她自己的缩写习惯。请读懂考生的真实意图，把这些任务智能分配到合适的日期。\n'
    ...
    + '5. 每个任务只写名称，不要括号说明；**考生原话里明确写出的时长必须原样保留在任务名里**（如"口语 30 分钟""背单词 1 小时"），这是考生自己的安排，严禁丢掉或擅自改数；考生没写时长的任务不要编造预估时长；任务名称用平白中文（如"听力 第1篇""阅读 第2篇""写作 第1篇""口语 P1 第1题""模考 听力+阅读"），不要出现 S1/S2、S3/S4 这类代号，听力/阅读也不得写 P1/P2/P3（仅口语 Part 代号 P1/P2 允许，出现在"口语 P1 第N题"命名里）；模考/刷题后必须紧跟对应复盘（错题复盘 / 精听 / 精读）；L 篇之间、R 篇之间同类分散避免疲劳；最难的 task 排最前。\n'
